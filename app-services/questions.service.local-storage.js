                        ...
                        questions: [
                            {
                                ...
                                answers: [
                                    ...
                                    {text: 'Go and hide in the toilet and text your friend telling them to get there urgently', points: 2},
                                    {text: 'Try to make yourself invisible by standing in the corner and staring at your phone', points: 3},
                                    {text: 'Loiter near the snack table and hope someone starts up a conversation with you', points: 4},
                                    {text: 'See if you can find the host and introduce yourself – it\'s only polite', points: 5},
                            ...
                            },
                            {
                                ...
                                answers: [
                                    ...
                                    {text: 'Listening and feeling a little awkward, but not feeling confident enough to talk much', points: 2},
                                    {text: 'Talking when you feel comfortable, but mostly listening from the fringes', points: 3},
                                    {text: 'Chipping in with jokes quite often and taking control of the conversation when you can', points: 4},
                                    {text: 'Leading the conversation, and probably making people laugh in the process', points: 5}
                                ]
                            },
                            {
                                ...
                                answers: [
                                    ...
                                    {text: 'It totally depends how I feel, some weeks I\'ll be really busy, others I just want to chill', points: 2},
                                    ...
                                    {text: 'I go along with most plans because of my crippling fear of missing out', points: 5}
                                ]
                            },
                            {
                                ...
                                answers: [
                                    ...
                                    {text: 'It always feels a little pointless, but it\'s not the worst thing in the world', points: 3},
